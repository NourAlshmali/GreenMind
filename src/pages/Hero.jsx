    ...
    <div className="bg-white w-full h-screen flex justify-center items-center">
      <div className="relative w-[88%] h-[78%] flex bg-[#C1DCDC] mt-10 rounded-2xl justify-center items-center">
        ...
        <div className="absolute left-[8%] top-[40%] md:top-[50%] lg:top-[55%] flex gap-10 ">
          ...
          <div className="w-px h-17 bg-black"></div>
          <div>
        ...
        <div className="absolute w-[30%] left-[5%] md:bottom-[25%] lg:bottom-[20%] sm:bottom-80 ">
          <div className="relative ">
            <input
              ...
              className="h-16 lg:w-full md:w-80 sm:w-64  md:placeholder:text-base sm:placeholder:text-sm
               bg-white rounded-2xl focus:border-2 border-white placeholder:pl-6 text-lg"
            />
            <div className="absolute top-3 right-0 mr-2.5 bg-[#C1DCDC] w-10 h-10 flex items-center justify-center   rounded-full">
        ...
        <div className="absolute lg:right-[20%] lg:bottom-22 ">
          <div className="relative w-112.5 h-97.25">
            <svg
              viewBox="0 0 450 389"
              xmlns="http://www.w3.org/2000/svg"
              className="absolute lg:top-22 lg:left-40 md:left-40 md:top-94 z-0 w-full h-auto sm:h-56 md:h-75 lg:h-97.5"
            >
              <path
            ...
            <img
              src={plant}
              alt="plant"
              className="absolute lg:left-[90%] transform -translate-x-1/2 z-10 lg:w-[32rem] lg:h-[38rem]
              md:w-[25rem] md:h-[37rem] sm:w-[19rem] sm:h-[26rem] md:left-[25rem] md:top-22 lg:top-[-35%]  "
            />
          </div>
        </div>
